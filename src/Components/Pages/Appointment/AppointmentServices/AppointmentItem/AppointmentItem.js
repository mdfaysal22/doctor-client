    ...
    return (
        <div className="card shadow-lg">
            <div className="card-body text-center">
                ...
                <div>
                <label htmlFor="booking-modal" onClick={() => {setTreatment(option)}} className='btn bg-gradient-to-tr from-primary to-secondary text-white border-0'>Booking Appointment</label>
                </div>
            </div>
        </div>
    );
